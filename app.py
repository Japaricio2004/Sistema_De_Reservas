...
@app.route('/citas_estudiante', methods=['GET', 'POST'])
@login_required  
def citas_estudiante():
    ...
    return render_template('citas_estudiante.html', citas=citas)
...
def cancelar_cita(id):
    cita = reservar_clase.query.get_or_404(id)
    ...
    if cita.user_id != current_user.id and cita.profesor_id != current_user.id:
        ...
        return redirect(url_for('citas_profesor'))
